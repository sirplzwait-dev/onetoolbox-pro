/* Simple Interest Calculator — tool-specific script */
(() => {
 ...
 dl.addEventListener('click',()=>{const blob=new Blob([output],{type:'text/plain'});const a=document.createElement('a');a.href=URL.createObjectURL(blob);a.download='simple-interest-calculator-result.txt';a.click();URL.revokeObjectURL(a.href);});
})();
